...
namespace Step2dev\LazySeoRedirect\Models;
...
class SeoRedirect extends Model
{
    ...
    protected static function booted(): void
    {
        ...
        static::saved(fn (): bool => Cache::forget('lazy-seo-redirect.patterns'));
        static::deleted(fn (): bool => Cache::forget('lazy-seo-redirect.patterns'));
    }

    public function getTable(): string
    {
        return config('lazy-seo-redirect.table', 'seo_redirects');
    }
